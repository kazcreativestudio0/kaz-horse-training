...
export const Partnerships: React.FC = () => {
  return (
    <section id={SectionId.PARTNERSHIPS} className="py-8 md:py-12 lg:py-16 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-display font-bold text-gray-900 mb-3 leading-tight">
            パートナーシップ
          </h2>
        </div>
